...
const disallowed = [
  ...
  { re: /\bSIGNAL\b/, msg: 'SIGNAL should be abbreviated as SI' },
  { re: /\bEV_PR\b/, msg: 'EV_PR should be abbreviated as EP' },
  { re: /\bEV_PROP\b/, msg: 'EV_PROP should be abbreviated as EP' },
